...
const Skill = ({ name, x, y }) => {
    return (
        <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute dark:text-dark dark:bg-light lg:py-2 lg:lx-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:text-bold'
...
const Skills = () => {
    return (
        <>
            <h2 className='font-bold text-7xl mt-64 w-full text-center md:text-5xl md:mt-32'>
                Skills
            </h2>
            ...
            '>
                ...
                <Skill name="TailwindCSS" x="-24vw" y="15vw" />
                <Skill name="Bootstrap" x="18vw" y="17vw" />
            </div>
        </>
    )
}
